<template>
    <section class="loginContainer">
          ...
          <form @submit.prevent="login">
            <div :class="{on:loginWay}">
              <section class="login_message">
                ...
                <button :disabled="!rightPhone" class="get_verification" :class="{right_phone: rightPhone}" @click.prevent="getCode">{{computeTime>0? `已发送验证码(${computeTime})`:'获取验证码'}}</button>
              </section>
            ...
            <div :class="{on:!loginWay}">
              <section>
                ...
                <section class="login_message">
                  ...
                  <img class="get_verification" src="http://localhost:4001/captcha" @click="refreshCaptcha" ref="captcha" alt="captcha">
                </section>
              </section>
            </div>
      ...
      <aler-tip :alertText="alertText" v-show="showAlert" @closeTip="closeTip"></aler-tip>
    </section>
</template>
<script>
